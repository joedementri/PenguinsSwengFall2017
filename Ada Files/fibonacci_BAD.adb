...
-- Read Max_Value, then print the numbers of the Fib sequence that are
...
//      procedure trackThisFunction is   //tests weakness 2
      /0                 //tests weakness 3


	-- Calculate and print Fib sequence values
...
//      procedure track3 is   //tests weakness 2
